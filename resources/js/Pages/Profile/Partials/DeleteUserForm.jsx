...
export default function DeleteUserForm({ className = '' }) {
    ...
    return (
        <section className={`space-y-6 ${className}`}>
            <header>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Deletar a Conta</h2>
            ...
            <DangerButton onClick={confirmUserDeletion}>Deletar a Conta</DangerButton>
